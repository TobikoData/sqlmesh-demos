MODEL (
  name airflow_demo.incremental_forward_only_model,
...
-- step 6: `sqlmesh plan --restate-model "airflow_demo.incremental_forward_only_model"`, to invoke a backfill to mirror dev's data preview
-- step 7: pick the same backfill start date for prod as dev's above: '2020-01-07'
-- step 8: validate changes to prod: `sqlmesh fetchdf "select * from airflow_demo.incremental_forward_only_model"`
